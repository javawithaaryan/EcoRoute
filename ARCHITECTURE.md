...
-   **Knowledge Base**: Local JSON files modeling campus sustainability programs, brand directories, and city garbage collection schedules.
-   **Core Processing**: Single-agent reasoning pipeline, with production targets including Google Gemini API for extraction and classification tasks.
